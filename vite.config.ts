...
export default ({ command, mode }: ConfigEnv): UserConfigExport => {
  ...
  const metaEnvObj = loadEnv(mode, envPath)
  console.log('metaEnvObj', metaEnvObj)
  ...
  return defineConfig({
    ...
    base: metaEnvObj.VITE_APP_PREFIX + metaEnvObj.VITE_APP_NAME,
    publicDir: metaEnvObj.VITE_APP_PREFIX + metaEnvObj.VITE_APP_NAME,
    build: {
